...
const AiChatSection = () => {
  ...
  return (
    <section id="ai-support" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl font-bold text-foreground mb-4">
            24/7 Mental Health First Aid
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Get immediate support with our AI companion trained in mental health first aid. 
            Safe, confidential, and available whenever you need it.
          </p>
        </div>
